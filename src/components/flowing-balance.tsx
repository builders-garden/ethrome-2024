...
export function toFixedUsingString(
  ...
  return `${wholePart}.0${decimalPartBigInt.toString().padStart(decimalPlaces, "0")}`;
}
...
const FlowingBalance: React.FC<{
  ...
  return (
    <div className="flowing-balance text-2xl font-extrabold !leading-none">
      $
      {decimalPlaces !== undefined
        ? toFixedUsingString(formatEther(flowingBalance), decimalPlaces - 1)
